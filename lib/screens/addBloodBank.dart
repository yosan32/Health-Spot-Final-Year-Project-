...
class AddBloodBank extends StatefulWidget {
  @override
  _AddBloodBankState createState() => _AddBloodBankState();
}
...
class _AddBloodBankState extends State<AddBloodBank> {
  ...
  void bloodBankForm() async {
    ...
    var res =
        await CallApi().postDataWithToken(data, 'bloodbanks', tokenString);
    ...
    if (body['status'] == 'success') {
      ...
      Navigator.pushReplacementNamed(context, '/bloodbank');
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Blood bank cannot be added'),
