...
class EditBloodBank extends StatefulWidget {
  List list;
  int index;
  EditBloodBank({this.index, this.list});
  @override
  _EditBloodBankState createState() => _EditBloodBankState();
}

class _EditBloodBankState extends State<EditBloodBank> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: NowDrawer(currentPage: "Blood Bank"),
        body: Stack(
          children: [
            Container(
